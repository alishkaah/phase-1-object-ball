...
//second Building Functions :Calling Functions Within Functions

function homeTeam() {
    let homeGameObject = gameObject().home
  return homeGameObject;
}
console.log(homeTeam())

function awayTeam() {
    let awayGameObject = gameObject().away
  return awayGameObject;
}
